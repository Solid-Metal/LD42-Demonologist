...
@:keep @:font("D:/Program Files/HaxeToolkit/haxe/lib/flixel/4,4,2/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:keep @:font("D:/Program Files/HaxeToolkit/haxe/lib/flixel/4,4,2/assets/fonts/monsterrat.ttf") #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
